<div class="p-6">
    ...
    <table class="min-wfull divide-y divide-gray-200">
        <thead>
            <tr>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            <tr>
                <td class="px-6 py-4 text-sm whitespace-nowrap">dummy title</td>
                <td class="px-6 py-4 text-sm whitespace-nowrap">dummy slug</td>
                <td class="px-6 py-4 text-sm text-right">dummy actions</td>
            </tr>
        </tbody>
    </table>
